 ...
 * Description: This is to add extra fields for WooCommerce Product
...
final class Plugin {
	...
	private function define() {
		 ...
		 * @since 0.9
		 */
		define( 'Extra_Fields', __FILE__ );
		define( 'Extra_Fields_DIR', dirname( Extra_Fields ) );
		define( 'Extra_Fields_ASSET', plugins_url( 'assets', Extra_Fields ) );
		define( 'Extra_Fields_DEBUG', apply_filters( 'extra-fields_debug', true ) );
		 ...
		 * @var $plugin
		 */
		$this->plugin					= get_plugin_data( Extra_Fields );
		$this->plugin['basename']		= plugin_basename( Extra_Fields );
		$this->plugin['file']			= Extra_Fields;
		$this->plugin['server']			= apply_filters( 'extra-fields_server', 'https://codexpert.io/dashboard' );
		$this->plugin['min_php']		= '5.6';
		$this->plugin['min_wp']			= '4.0';
		$this->plugin['icon']			= Extra_Fields_ASSET . '/img/icon.png';
