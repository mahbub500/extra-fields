...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'extra-fields' ),
		'products'			=> __( 'Products', 'extra-fields' ),
		'order_total'		=> __( 'Order Total', 'extra-fields' ),
		'commission'		=> __( 'Commission', 'extra-fields' ),
		'payment_status'	=> __( 'Payment Status', 'extra-fields' ),
		'time'				=> __( 'Time', 'extra-fields' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'extra-fields' ),
		'draft'		=> __( 'Draft', 'extra-fields' ),
	],
];
